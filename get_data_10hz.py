...
WIFI_SERVER_IP = '192.168.0.177'  # 로컬 PC의 IP 주소
...
filename = f"imu_data_10hz_{timestamp}.csv"

print(f"Data collection started (10Hz) - Save file: {filename}")
